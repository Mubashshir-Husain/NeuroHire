                    ...
                    <div className='grid gap-6'>
                        {
                            interviews.map((item, index) => (
                                ...
                                onClick={()=>navigate(`/report/${item._id}`)}
                                 className='p-6 bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer border border-gray-100'>
                                ...
                                <div className='flex items-center gap-6'>
                                 ...
                                 {/* STATUS BADGE */}
                                 <span className={`px-4 py-2 rounded-full text-xs font-medium ${item.status === "completed" ? "bg-emerald-100 text-emerald-600" : "bg-yellow-100 text-yellow-700"}`}>
                                    {item.status}
                                 </span>
                                </div>
                                    </div>

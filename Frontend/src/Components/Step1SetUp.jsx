          ...
          <div className='space-y-5'>
            {
              [
                ...
                <motion.div key={index}
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.6 + index * 0.20, duration: 0.3 }}
        ...
        <motion.div
          ...
          <div className='space-y-6'>
            <div className='relative'>
              ...
              <input type="text" placeholder='Enter your role' className='w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition' onChange={(e) => setRole(e.target.value)} value={role} />
            </div>
            ...
            {!analysisDone && (
              <motion.div
                ...
                className='border-2 border-dashed border-gray-300 rounded-xl p-4 text-center cursor-pointer hover:border-green-500 transition'>
                <FaFileUpload className='text-4xl mx-auto text-green-600 mb-3' />
                <input type="file" accept="application/pdf" id="resumeUpload" name='resume'
                  className='hidden'
